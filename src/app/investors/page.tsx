        ...
        {paginatedInvestors.map((inv, idx) => (
          ...
          >
            ...
            <div className="flex items-center gap-1 flex-wrap">
              {inv.tags && inv.tags.split(";").filter(Boolean).slice(0, 2).map((tag) => (
                <span key={tag} className="text-[10px] px-2 py-0.5 bg-emerald-50 text-emerald-700 rounded-lg font-medium">
